    ...
    <AnimatePresence>
      {visible && (
        <>
          ...
          {/* Slide-over panel */}
          <motion.div
            className="fixed top-0 right-0 z-50 flex flex-col w-full sm:w-[420px] h-full bg-zinc-900/95 backdrop-blur-xl border-l border-zinc-700/60 shadow-2xl shadow-black/50"
            initial={{ x: "100%" }}
            animate={{ x: 0 }}
            exit={{ x: "100%" }}
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-orange-500/90 to-amber-500/90 shrink-0">
              <div className="w-8 h-8 rounded-xl bg-white/20 flex items-center justify-center">
                <MessageSquare className="w-4 h-4 text-white" />
              </div>
              <button
                onClick={onClose}
                className="w-7 h-7 rounded-lg bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors text-white/80 hover:text-white"
